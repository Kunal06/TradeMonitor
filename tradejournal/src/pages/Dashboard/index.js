...
const Dashboard = (props) => {
    ...
    useEffect(() => {
        if (balance.balance.length > 1) {
            ...
            const lastMonthTrade =
                balance.dates[balance.dates.length - 1].split("-");
            lastMonthTrade[2] = "1";
            const firstDay = lastMonthTrade.join("-");
            const firstDayIndex = balance.dates.findIndex(
                (date) => date >= firstDay
            );
            const monthlyPln =
                firstDayIndex !== 0
    ...
    useEffect(() => {
        ...
        for (let pair in sortable) {
            ...
            if (sortable[pair].gain < 0)
                bottom.push({ pair, ...sortable[pair] });
        }
            ...
            {balance.balance.length > 1 ? (
                <>
                    <div className="row">
                        <div className="col-5 ">
                            <Card
                                ...
                                subValue={
                                    balance.dates[balance.dates.length - 1]
                                }
                            >
                                <Chart
                    ...
                    <div className="balance">
                        {balance.balance}
                        <h4 className="balance_header">
                            PLN EVOLUTION FOR ACCOUNT
                        </h4>
                        <div className="chart">
                            <Chart
                ...
                <section className="section">
                    ...
                    <p>
                        To get started, please add at least <strong>one</strong>{" "}
                        trade to populate your dashboard.
                    </p>
